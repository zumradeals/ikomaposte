-- ===========================================
-- IKOMA Poste - Données de test (DEV ONLY)
-- ===========================================
-- Usage: psql $SUPABASE_DB_URL -f scripts/seed.sql
-- ⚠️  NE PAS UTILISER EN PRODUCTION
-- Ce script insère des données de test pour le développement
...
INSERT INTO public.work_events (id, worker_id, device_id, device_secret, event_type, occurred_at, trust_status) VALUES
    (gen_random_uuid(), 'aaaa1111-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'KIOSK-ENTREE-01', 'secret_entree_01_dev', 'check_in', NOW() - INTERVAL '1 day' + INTERVAL '8 hours', 'trusted'),
    (gen_random_uuid(), 'aaaa1111-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'KIOSK-ATELIER-01', 'secret_atelier_01_dev', 'pause_start', NOW() - INTERVAL '1 day' + INTERVAL '12 hours', 'trusted'),
    (gen_random_uuid(), 'aaaa1111-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'KIOSK-ATELIER-01', 'secret_atelier_01_dev', 'pause_end', NOW() - INTERVAL '1 day' + INTERVAL '13 hours', 'trusted'),
    (gen_random_uuid(), 'aaaa1111-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'KIOSK-SORTIE-01', 'secret_sortie_01_dev', 'check_out', NOW() - INTERVAL '1 day' + INTERVAL '17 hours', 'trusted')
ON CONFLICT DO NOTHING;

-- Jour 1: Hier - Fatou (sans pause)
INSERT INTO public.work_events (id, worker_id, device_id, device_secret, event_type, occurred_at, trust_status) VALUES
    (gen_random_uuid(), 'aaaa2222-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'KIOSK-ENTREE-01', 'secret_entree_01_dev', 'check_in', NOW() - INTERVAL '1 day' + INTERVAL '8 hours 15 minutes', 'trusted'),
    (gen_random_uuid(), 'aaaa2222-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'KIOSK-SORTIE-01', 'secret_sortie_01_dev', 'check_out', NOW() - INTERVAL '1 day' + INTERVAL '16 hours 30 minutes', 'trusted')
ON CONFLICT DO NOTHING;

-- Jour 2: Avant-hier - Mamadou demi-journée
INSERT INTO public.work_events (id, worker_id, device_id, device_secret, event_type, occurred_at, trust_status) VALUES
    (gen_random_uuid(), 'aaaa1111-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'KIOSK-ENTREE-01', 'secret_entree_01_dev', 'check_in', NOW() - INTERVAL '2 days' + INTERVAL '8 hours', 'trusted'),
    (gen_random_uuid(), 'aaaa1111-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'KIOSK-SORTIE-01', 'secret_sortie_01_dev', 'check_out', NOW() - INTERVAL '2 days' + INTERVAL '12 hours', 'trusted')
ON CONFLICT DO NOTHING;

-- Jour 3: Aujourd'hui - Plusieurs travailleurs actifs (sans check_out)
INSERT INTO public.work_events (id, worker_id, device_id, device_secret, event_type, occurred_at, trust_status) VALUES
    (gen_random_uuid(), 'aaaa1111-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'KIOSK-ENTREE-01', 'secret_entree_01_dev', 'check_in', NOW() - INTERVAL '3 hours', 'trusted'),
    (gen_random_uuid(), 'aaaa2222-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'KIOSK-ENTREE-01', 'secret_entree_01_dev', 'check_in', NOW() - INTERVAL '2 hours 45 minutes', 'trusted'),
    (gen_random_uuid(), 'bbbb1111-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'KIOSK-ENTREE-01', 'secret_entree_01_dev', 'check_in', NOW() - INTERVAL '2 hours 30 minutes', 'trusted'),
    (gen_random_uuid(), 'cccc1111-cccc-cccc-cccc-cccccccccccc', 'KIOSK-ENTREE-01', 'secret_entree_01_dev', 'check_in', NOW() - INTERVAL '2 hours', 'trusted')
ON CONFLICT DO NOTHING;

-- ===========================================
-- Résumé de travail calculé (pour hier)
-- ===========================================
INSERT INTO public.work_summaries (
    id, worker_id, work_date, 
    total_work_minutes, total_pause_minutes, total_amount,
    taux_horaire_applied, devise, calculation_version,
    events_used, auto_closed
) VALUES
    (
        gen_random_uuid(),
